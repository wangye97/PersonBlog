<template>
    <div class="box">
      <div class="header banner">
        ...
        <div ref="personInfo" class="right-header transition-box more" :style="{height:clientWidth>768?'18px':clientHeight-1+'px'}">
          <div class="fork-left">
        ...
        <transition name="el-zoom-in-center">
        <div ref="personInfo" class="right-header transition-box less" v-show="isShow" :style="{height:clientWidth>768?'18px':clientHeight-1+'px'}">
          <div class="fork-left">
            <div class="el-icon-user-solid" @click="showState">
              <router-link class="active" to="/home">主页</router-link>
            </div>
