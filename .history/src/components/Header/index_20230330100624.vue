<template>
  <div class="box">
    <div ref="vantaRef" style="width: 100vw; height: 170px"></div>
...
export default {
  ...
  mounted(){
    ...
    this.$nextTick(// 修改颜色时 cells 需要全大写字母 可生效
    VANTA.BIRDS({
      el: this.$refs.vantaRef,
      mouseControls: true,
  touchControls: true,
