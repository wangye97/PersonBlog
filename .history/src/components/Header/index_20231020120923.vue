...
@media only screen and (max-width: 768px) {
  ...
  .contain .box .header .nav-contain {
    display: block;
    width: 18px;
    height: 48px;
    position: relative;
  ...
  .contain .box .header .nav-contain li {
    height: 1px;
    width: 100%;
    position: absolute;
    background-color: #000;
  }
  .contain .box .header .nav-contain li:nth-child(1) {
    top: 16px;
  }
  .contain .box .header .nav-contain li:nth-child(2) {
    top: 24px;
  }
  .contain .box .header .nav-contain li:nth-child(3) {
    bottom: 16px;
  }
  .contain .box .header .left-header {
    order: 2;
  }
  .contain .box .header .right-header {
    position: absolute;
    left: 0;
    top: 0;
    width: 100%;
  ...
  .contain .box .header .right-header .fork-left div {
    display: block;
    width: 100%;
    height: 48px;
    line-height: 48px;
  ...
  .contain .box .header .right-header .fork-left div a {
    font-family: 隶书;
    color: #000;
    font-size: 18px;
  } 
  .contain .box .header .right-header .fork-left div a:hover {
    font-family: 隶书;
  } 
  .contain .box .header .right-header .fork-left{
    width: 80%;
    height: 100%;
  ...
  .contain .box .header .right-header .fork{
    display: block;
    width: 20%;
    height: 100%;
  ...
  .contain .box .header .right-header .fork li{
    width: 20px;
    height: 2px;
    background: #000;
    opacity: .6;
  ...
  .contain .box .header .right-header .fork li:nth-child(1){
      transform: rotate(65deg);
  }
  .contain .box .header .right-header .fork li:nth-child(2){
    transform: rotate(-65deg);
  }

  .contain .box .header .right-header .fork-left .setting {
    display: none;
  }
