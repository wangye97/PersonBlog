<template>
  <div class="contain" style="min-height: 20%;min-width: 1215px; background-color: aliceblue;">
    <div class="box">
      <div class="header banner">
        ...
        <div ref="personInfo" class="right-header transition-box" v-show="isShow" :style="{height:clientWidth>751?'18px':clientHeight-1+'px'}">
          <div class="fork-left">
...
export default {
  ...
  watch: {
    clientWidth: {
      immediate: true,
      handler(newold) {
        if (newold >751) this.isShow = true;
        else {
          this.isShow = false;
          this.once = 0;
        }
