  ...
  <div >
    <div class="box">
      <div class="header banner">
        ...
        <div ref="personInfo" class="right-header transition-box" v-show="isShow" :style="{height:clientWidth>784?'18px':clientHeight-1+'px'}">
          <div class="fork-left">
...
export default {
  ...
  watch: {
    clientWidth: {
      ...
      handler(newold) {
        console.log(newold);
        if (newold +17>= 768) this.isShow = true;
        else {
          this.isShow = false;
          this.once = 0;
        }
