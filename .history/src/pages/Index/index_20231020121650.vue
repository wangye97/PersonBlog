<template>
  <div style="min-height: 80%; background-color:rgb(223, 225, 228); min-width: 1215px;">
      <div style="height: 599px; background-color: rgb(223, 225, 228); width: 1215px; margin: 0 auto;">
        <div class="random" >
