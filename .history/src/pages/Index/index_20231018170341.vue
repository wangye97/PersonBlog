<template>
  <div style="min-height: 80%; background-color: rgb(223, 225, 228);">
    <div style="height: 600px; background-color: rgb(223, 225, 228);">
      <div class="random" >
            <h1 style="font-size: 35px">{{ getRandom }}</h1>
          <div style="display: flex; justify-content: space-evenly;background-color: red;">
