      ...
      <div class="contain">
        <transition-group name="hello" appear>
          <div v-for="(h,index) in homeInfo" :key="h.id" class="capital" >
            <div v-show="index%2==0" class="active" @click="skip(h)">
              <h1>{{h.title}}</h1>
              <div class="inner">
                <div>
            ...
            <div class="img-contain"><img ref="img" :src="h.img" alt="" class="imgs"></div>
        
        
            <div v-show="index%2==1" class="active" @click="skip(h)">
              <h1>{{h.title}}</h1>
              <div class="inner">
                <div>
                  <img :src="h.avatar" alt="" style="width: 30px; height: 30px; border-radius: 50%;">
...
<style scoped>
  ...
  @media only screen and (max-width:768px){
    ...
    .contain .capital .img-contain .imgs{
      width: 100%;
      height: 100%;
    }
