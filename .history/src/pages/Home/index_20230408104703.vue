    ...
    <div class="wrapper">
      <div class="contain">
        <transition-group name="hello" appear>
          <div v-for="(h,index) in homeInfo" :key="h.id" class="capital" @click="skip(h)">
          <div style="width: 280px;height: 200px;" v-show="index%2==0" class="active">
            <h1>{{h.title}}</h1>
            <div class="inner">
              <div>
          ...
          <div style="width: 280px;height: 200px;" v-show="index%2==1" class="active">
            <h1>{{h.title}}</h1>
            <div class="inner">
              <div>
                <img :src="h.avatar" alt="" style="width: 30px; height: 30px; border-radius: 50%;">
