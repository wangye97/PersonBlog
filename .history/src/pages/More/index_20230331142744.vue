    ...
    <div style="margin-top: 30px; overflow: hidden;">
        ...
        <div class="contain">
            <div class="wrapper-top">
                ...
                <div>
                    <input type="text" placeholder="搜索名称" class="ipts" v-model="resourceName">
                    <button class="btn" style="background-color: green;margin: 0 20px; color: aliceblue;" @click="search">搜索</button>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        search(){
            if(this.category==''){
                this.getMoreInfo=[]
                this.getMoreInfo.map(item=>{
                    if(item.title.toUpperCase().indexOf(this.resourceName.toUpperCase())!=-1){
                        this.getMoreInfo.push(item)
                    }
                })
            }
        }
