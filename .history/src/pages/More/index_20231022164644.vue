            ...
            <div class="contain">
                <div class="wrapper-top">
                    <div style="margin-left: 20px;">
                        ...
                        <button class="btn btns" style="background-color: skyblue;margin-left: 10px;" @click="category='学习类'">学习类</button>
                        <button class="btn btns" style="background-color: skyblue;margin-left: 10px;" @click="category='娱乐类'">娱乐类</button>
                        <button class="btn btns" style="background-color: skyblue;margin-left: 10px;" @click="category=''">查看全部资源</button>
                    </div> 
                    <div class="nice">
                        <input type="text" placeholder="搜索名称" class="ipts">
                        <button class="btn buttons" style="background-color: green;margsin: 0 20px; color: aliceblue;">搜索</button>
                    </div>
                </div>
...
<style scoped>
   ...
   .wrapper{
    ...
    @media  only screen and (max-width:768px) {
        ...
        .wrapper .contain .wrapper-top{
            width: 100%;
        }
        .wrapper .contain .wrapper-top .btns{
            display: none;
        }
        .wrapper .contain .wrapper-top .btn{
            width: 60px;
        }
        .wrapper .contain .wrapper-top .nice .buttons{
            margin: 0 6px;
        }
        .contain .wrapper-top .ipts{
            width: 100px;
        }
        .wrapper .contain .wrapper-bottom{
            width: 100%;
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        .image-gallery .image-wrapper .image-contain{
            width: 340px;
        }
    }
</style>