  ...
  <div>
   ...
   <div>
        ...
        <div class="image-gallery">
            <div class="image-contain" v-for="item in someImg" :key="item.id">
                <img :src="item.imgUrl" alt="">
            </div>
            <button class="btn btnMore" @click="loadMore3" v-show="imgNum<getMoreImg.length">加载更多</button>
        </div>
   </div>
  </div>
</template>
...
<style scoped>
    ...
    .image-gallery .image-contain .btns{
        cursor: pointer;
        width: 80px;
        height: 30px;
        border-radius: 5px;
