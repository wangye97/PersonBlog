        ...
        <div class="contain">
            <div class="wrapper-top">
                <div style="margin-left: 20px;">
                    ...
                    <span v-else>{{getMoreInfo[0].category}} (共{{getPlayInfo.length+getStudyInfo.length}}个资源)</span>
            ...
            <div v-show="category=='娱乐类'||category==''">
                ...
                <div class="wrapper-bottom">
                    <div class="wrapper-box" v-for="item in getPlayInfo" :key="item.id" v-show="item.category=='娱乐类'">
                        <img class="imgs" :src="item.imgUrl" alt="">
                        <div style="display: flex; flex-direction: column;">
                            <h1 style="margin: 15px 0;">{{item.title}}</h1>
                            <span>{{item.text}}</span>
