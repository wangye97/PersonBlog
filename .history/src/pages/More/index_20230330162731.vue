        ...
        <div class="contain">
            <div class="wrapper-top">
                <div style="margin-left: 20px;">
                    ...
                    <span>{{getMoreInfo[0].category}} (共{{getMoreInfo.length}}个资源)</span>
            ...
            <div v-show="category=='学习类'||category==''">
                <h1 style="text-align: center;">{{getStudyInfo.category}}</h1>
                <div class="wrapper-bottom">
                    <div class="wrapper-box" v-for="item in getStudyInfo" :key="item.id" v-show="item.category=='学习类'">
            ...
            <div v-show="category=='娱乐类'||category==''">
                <h1 style="text-align: center;">{{getMoreInfo[0].category}}</h1>
                <div class="wrapper-bottom">
                    <div class="wrapper-box" v-for="item in getMoreInfo" :key="item.id" v-show="item.category=='娱乐类'">
                        <img class="imgs" :src="item.imgUrl" alt="">
                        <div style="display: flex; flex-direction: column;">
                            <h1 style="margin: 15px 0;">{{item.title}}</h1>
                            <span>{{item.text}}</span>
