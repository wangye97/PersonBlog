<template>
      ...
      <div class="wrapper">
          <transition name="hello" appear>
            <div class="login-contain">
              ...
              <div>
                  <input ref="username" type="text" class="input-item" placeholder="username" v-model="user.username">
                  <input type="password" class="input-item" placeholder="oldPassword" v-model="user.password">
                  <input type="password" class="input-item" placeholder="newPassword" v-model="user.newPwd">
  ...
  export default {
      ...
      methods:{
          async reset(){
            const {username,password,newPwd}=this.user
